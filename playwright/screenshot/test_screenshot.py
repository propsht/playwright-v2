...
def visit_playwright(page: Page):
    ...
    page.screenshot(path="/Users/propsht/Documents/QA/projects/playwright-v2/playwright/screenshot.png", full_page=True)
    link = page.get_by_role("link", name="GET STARTED")
    page.screenshot(path="get-started.png")
    link.click()
    yield page
...
def test_page_has_docs_link(page: Page):
    ...
    link.click()
    page.screenshot(path="/Users/propsht/Documents/QA/projects/playwright-v2/playwright/doc.png", full_page=True)
